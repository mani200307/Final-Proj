...
<style>
    ...
    echo "<h1 class = 'text-center text-bold text-3xl'>Added Successfully!!!</h1>";?>
  ...
  <div class="d-flex justify-content-center align-items-center mx-auto" style="min-height:80vh">
        ...
        <select class="mb-3 form-select" aria-label="Default select example" name="status">
         ...
         <button type="submit" name="submit" class="btn btn-primary text-black fs-4 " >Submit</button>
         </div>
  </div>
 </form>
...
if (isset($_POST['regno'])&& isset($_POST['submit'])&&isset($_POST['type']) && isset($_POST['make'])&& isset($_POST['status'])&& isset($_POST['fuel']))
{
    $regno=$_POST['regno'];
